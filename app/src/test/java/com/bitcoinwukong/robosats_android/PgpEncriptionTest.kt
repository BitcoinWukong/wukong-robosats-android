...
class PgpKeyGeneratorTest {
    ...
    fun testReadPublicKey() {
        ...
        assertEquals(keyId, pgpPrivateKey.encryptionKey.keyID)
    }
    ...
    fun testCreatePGPEncryptedData() {
        ...
        val generatedEncryptedData = getPGPPublicKeyEncryptedDataFromByteArray(
            createPGPEncryptedDataByteArray(
                message,
                signatureKey,
    ...
    fun testEncryptMessage() {
        val publicKeyArmor = "-----BEGIN PGP PUBLIC KEY BLOCK-----\n" +
                ...
                "        =8/1E\n" +
                "        -----END PGP PUBLIC KEY BLOCK-----"
        val publicKey2Armor = "-----BEGIN PGP PUBLIC KEY BLOCK-----\n" +
                "\n" +
        ...
        val (signatureKey, _) = decryptPrivateKeys(encryptedPrivateKey, token)
